...
import {EnseignementService} from "../../../services/entities";

@Component({
    selector: 'jhi-enseignement',
    templateUrl: './professeur-enseignements.component.html'
})
export class ProfesseurEnseignementsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    transition() {
        this.router.navigate(['/pages/professeur/enseignements'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        ...
        this.router.navigate([
            '/pages/professeur/enseignements',
            {
                page: this.page,
                sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
            }
