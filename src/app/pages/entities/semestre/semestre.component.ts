...
export class SemestreComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.semestreService
            ...
            .subscribe(
                (res: HttpResponse<ISemestre[]>) => this.paginateSemestres(res.body, res.headers),
    ...
    trackId(index: number, item: ISemestre) {
        return item.id;
    }

    registerChangeInSemestres() {
        this.eventSubscriber = this.eventManager.subscribe('semestreListModification', response => this.loadAll());
    }
    ...
    protected paginateSemestres(data: ISemestre[], headers: HttpHeaders) {
