...
import { ModuleService } from '../../../services/entities/module.service';
...
export class ModuleComponent implements OnInit, OnDestroy {
        ...
        this.moduleService
            ...
            .subscribe(
                (res: HttpResponse<IModule[]>) => {
                  this.loading=false;
                  this.paginateModules(res.body, res.headers)
                }
                  ,
    ...
    protected paginateModules(data: IModule[], headers: HttpHeaders) {
